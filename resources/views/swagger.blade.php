{
  ...
  "info": {
    ...
    "description": "An API for an aggregator of Art Institute of Chicago public data. This documentation was generated by `php artisan docs:swagger` on 2018-03-20 14:38:40",
  ...
  "host": "aggregator-data-test.artic.edu",
  "basePath": "/api/v1",
  "schemes": [
    "http"
  ],
  "paths": {
    ...
    "/links/search": {
      "get": {
        ...
        "summary": "Search links data in the aggregator. ",
        "produces": [
          "application/json"
        ],
        "parameters": [
    ...
    "/links/{id}": {
      "get": {
        ...
        "summary": "A single link by the given identifier. {id} is the identifier from our collections managements system.",
        "produces": [
          "application/json"
        ],
        "parameters": [
    ...
    "/tour-stops/search": {
      "get": {
        ...
        "summary": "Search tour-stops data in the aggregator. ",
        "produces": [
          "application/json"
        ],
        "parameters": [
  ...
  "definitions": {
    ...
    "Artwork": {
      "properties": {
        ...
        "copyright_representative_ids": {
          "description": "Unique identifiers of the copyright representatives associated with this work"
        },
        "part_ids": {
        ...
        "date_dates": {
          "description": "List of all the dates associated with this work. Includes creation dates, and may also include publication dates for works on paper, exhibition dates for provenance, found dates for archaeological finds, etc."
        },
        ...
        "image_iiif_url": {
          "description": "IIIF URL of the preferred image to use to represent this work"
        },
        "alt_image_ids": {
          "description": "Unique identifiers of all non-preferred images of this work. The order of this list will not correspond to the order of `image_iiif_urls`."
        },
        "alt_image_iiif_urls": {
          "description": "IIIF URLs of all the images of this work. The order of this list will not correspond to the order of `image_ids`."
        },
        "sound_ids": {
        ...
        "link_ids": {
          "description": "Unique identifiers of the links about this work"
        },
        "text_ids": {
    ...
    "Category": {
      "properties": {
        ...
        "is_in_nav": {
          "description": "Whether this category was included in the departmental navigation in the old collections site"
        },
        "description": {
          "description": "Explanation of what this category is"
        },
        "sort": {
          "description": "Number representing this category's sort order"
        },
        "type": {
          "description": "Number representing the type of category. 1 is departmental, 2 is subject, 3 is theme, 5 is multimedia."
        },
        "last_updated_source": {
          "description": "Date and time the resource was updated in the LAKE LPM Solr index, which is our direct source of data"
        },
    ...
    "Exhibition": {
      "properties": {
        ...
        "image_id": {
          "description": "Unique identifier of the image to use to represent this exhibition"
        },
        "image_iiif_url": {
          "description": "IIIF URL of the image to use to represent this exhibition"
        },
    ...
    "Image": {
      "properties": {
        ...
        "type": {
          "description": "Type always takes one of the following values: image, link, sound, text, video"
        },
        "description": {
