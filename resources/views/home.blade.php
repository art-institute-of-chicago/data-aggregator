...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <p>The Art Institute of Chicago's API provides JSON formatted data as a REST-style service that allows developers to explore and integrate the museum’s data into their projects. This API is the same tool that powers our website, mobile app, and many other technologies in the museum.</p>

            <h2>Getting started</h2>
            <p>API requests are made by accessing various endpoints at {{ config('app.url') }}/api/v1. Read more about our <a href="/docs/endpoints">endpoints</a> and <a href="/docs/fields">fields</a> in our documentation to learn about query parameters you can use to manipulate your query.</p>
            ...
            <p>If the application you're building will be public, please send it our way! We'd love to share it alongside some of the other projects that use our API. And if you have any question, please feel free to reach out to us: _____________@artic.edu.</p>
