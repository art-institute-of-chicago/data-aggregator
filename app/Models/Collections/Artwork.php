...
class Artwork extends CollectionsModel
{
    ...
    public static function boostedIds()
    {
        return array_merge(
            [
                ...
                76279, 183277, 73216, 185180, 111380, 56731, 9512, 11272, 127644, 185222, 88977, 89856, 89503, 153244, 24548,
    ...
    public function toSearchableArray()
    {
        ...
        // If the embeddings values are empty, explicitly set them to null
