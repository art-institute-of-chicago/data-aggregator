...
$factory->define(App\Models\Dsc\Section::class, function (Faker\Generator $faker) {
    return array_merge(
        ...
        [
            ...
            'parent_id' => !rand(0, 3) ? null : $faker->randomElement(App\Models\Dsc\Section::query()->pluck('dsc_id')->all()),
            'publication_dsc_id' => $faker->randomElement(App\Models\Dsc\Publication::query()->pluck('dsc_id')->all()),
