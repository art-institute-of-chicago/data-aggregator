    ...
    public function definition()
    {
        ...
        return array_merge(
            ...
            [
                ...
                'artwork_type_citi_id' => $this->faker->randomElement(App\Models\Collections\ArtworkType::query()->pluck('citi_id')->all()),
                'gallery_citi_id' => $this->faker->randomElement(App\Models\Collections\Place::query()->pluck('citi_id')->all()),
            ],
            $this->dates(true)
        );
    }
