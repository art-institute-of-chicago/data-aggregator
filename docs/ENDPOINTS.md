...
A list of all archival-images sorted by last updated date in descending order. For a description of all the fields included with this response, see [here](FIELDS.md#archival-images).
...
Example request: http://data-aggregator.test/api/v1/archival-images?limit=2  
Example output:
...
```
{
    "pagination": {
        ...
        "total_pages": 27796,
        "current_page": 1,
        "next_url": "http:\/\/data-aggregator.test\/api\/v1\/archival-images?page=2&limit=2"
    },
    "data": [
        {
            "id": 25600,
...
A single archival-images by the given identifier.
...
> Generated by `php artisan docs:endpoints` on 2018-01-08 11:39:29
